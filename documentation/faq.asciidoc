...
Kafka Connect introduced a set of dedicated REST API endpoints for managing connector offsets as part of https://cwiki.apache.org/confluence/display/KAFKA/KIP-875%3A+First-class+offsets+support+in+Kafka+Connect[KIP-875].
